...
ABSL_MUST_USE_RESULT ProtobufUtil::Status ConnectionImpl::dispatch(Buffer::Instance& data) {
...
ProtobufUtil::StatusOr<ssize_t> ConnectionImpl::dispatchSlice(const char* slice, size_t len) {
